...
export async function poolRoutes(fastify: FastifyInstance) {
    //  Faz a contagem de quantos bolões existem
    ...
    // Criar um bolão, estando logado ou não
    ...
    //  Lista todos os bolões relacionadas ao user logado, traz tbm 4 participants, suas respectivas imagens e id
